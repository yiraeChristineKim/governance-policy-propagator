...
require (
	...
	open-cluster-management.io/addon-framework v0.9.3 // indirect
	open-cluster-management.io/config-policy-controller v0.15.1-0.20250310165757-ae83665d98b2 // indirect
